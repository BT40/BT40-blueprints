...
class PDFD(FPDF):
    ...
    def header(self):
        ...
        self.cell(80)
        # Framed title
        self.cell(70, 10, 'This is header', 1, 0, 'C')
        # Line break
        self.ln(20)
    ...
    def footer(self):
        ...
        self.set_font('Arial', '', 8) # Empty second parameter indicates normal, that is not bold, not underline (B, U capital)
        # Print centered page number
        self.cell(0, 10, 'Page %s' % self.page_no(), 0, 0, 'C')

document=PDFD (orientation = 'P', unit = 'mm', format='A4')
...
#pdf creating.
document.set_text_color(10, 10, 15) # Set font colour of footer, footer fn it is automatically called by output function.
